import { DOMAIN_LABELS, IMPLEMENTATION_STATUSES, MASTER_SOURCE_REGISTRY, SOURCE_ACCESS_CLASSIFICATIONS, SOURCE_DOMAINS, SOURCE_QUALITY_TIERS, filterSources, sourceById, sourceRegistryStats, validateSourceRegistry } from "../sources/master-source-registry.js";
...
function paramsFromUrl(url) {
  ...
  return {
    ...
    category: allowedValue(search.get("category"), [...new Set(MASTER_SOURCE_REGISTRY.map((source) => source.category))]),
