...
export const EVENT_PROVIDERS = [
  ...
  {
    ...sourceMetadata("nasa-firms"),
    id: "nasa-firms",
    name: "NASA FIRMS",
    description: "NASA Fire Information for Resource Management System VIIRS thermal anomaly detections. Requires free MAP_KEY; detections are sensor products, not confirmed incidents.",
  ...
  {
    ...sourceMetadata("noaa-swpc"),
    id: "noaa-swpc",
    name: "NOAA Space Weather Prediction Center",
    description: "Official NOAA SWPC space weather alerts from the public products API (non-geographic).",
