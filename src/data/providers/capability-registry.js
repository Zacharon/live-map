...
export const PROVIDER_CAPABILITIES = {
  ...
  "nasa-firms": capability({
    supportedDomains: ["natural-disaster"],
    supportsGeometry: true,
    requiresKey: true,
    licenseClass: "map-key-required",
    expectedVolume: "high",
    sensitivityLevel: "low",
  }),
  "noaa-swpc": capability({ supportedDomains: ["weather"], supportedRecordKinds: ["event"], expectedVolume: "low" }),
